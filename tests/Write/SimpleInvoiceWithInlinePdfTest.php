...
class SimpleInvoiceWithInlinePdfTest extends TestCase
{
    ...
    public function testIfXMLIsValid()
    {
        ...
        $fileStream = file_get_contents(__DIR__.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'Files'.DIRECTORY_SEPARATOR.'SampleInvoice.pdf'); // this would be your file contents

        $base64EncodedFileStream = base64_encode($fileStream);

        $attachment = (new \NumNum\UBL\Attachment())
            ->setBase64Content($base64EncodedFileStream, 'Invoice.pdf', 'application/pdf');
